...
export default function PdfToMdTool() {
  ...
  return (
    <div className="max-w-lg mx-auto">
      <h2 className="text-lg font-semibold text-gray-800 mb-4">提取 Markdown</h2>
      ...
      {isEmpty && (
        <div className="text-center py-8">
          <p className="text-gray-500 text-sm mb-2">此 PDF 可能为扫描件，无可提取的文本</p>
      ...
      {markdown.length > 0 && (
        <div className="space-y-3">
          <div className="flex gap-2">
            <button
              onClick={handleCopy}
              className="flex items-center gap-1.5 px-4 py-2 rounded-lg text-sm font-medium border border-gray-200
          ...
          <textarea
            readOnly
            value={markdown}
            className="w-full h-80 px-4 py-3 border border-gray-300 rounded-lg text-sm font-mono text-gray-700
              bg-gray-50 resize-y focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500"
          />
